...
import TodoList from "../../images/todo-list-svgrepo-com (1).svg";
import { useNavigate } from "react-router-dom"; // Import useNavigate
import Cookies from "js-cookie"; // ImporLinkt js-cookie
import { Link } from "react-router-dom"; // Import useNavigate and Link

export default function Navbar({ SignIn, Home, SignUp, Logout, Dashboard }) {
    ...
    <div>
      <nav class="bg-white border-gray-200 dark:bg-gray-900">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          >
            <img src={TodoList} class="h-8" alt="Flowbite Logo" />
